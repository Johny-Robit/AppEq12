# Generated by Django 5.1.5 on 2025-04-07 00:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=events.models.default_expires_at)),
                ('refresh_expires_at', models.DateTimeField(default=events.models.default_refresh_expires_at)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pending_invites', models.ManyToManyField(blank=True, related_name='pending_invites', to=settings.AUTH_USER_MODEL)),
            ],
            options={
